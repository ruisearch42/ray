...
import ray
from ray.dag.dag_operation_future import DAGOperationFuture, WrappedFuture
...
class ReaderInterface:
    ...
    def _read_list(self, timeout: Optional[float] = None) -> List[DAGOperationFuture]:
        """
    ...
    def read(self, timeout: Optional[float] = None) -> List[DAGOperationFuture]:
        """
